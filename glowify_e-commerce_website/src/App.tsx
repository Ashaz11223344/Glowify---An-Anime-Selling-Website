...
export default function App() {
  const [currentView, setCurrentView] = useState<"home" | "product" | "cart" | "admin" | "account" | "custom">("home");
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="min-h-screen flex items-center justify-center p-2 sm:p-4 relative overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-sm sm:max-w-md">
            ...
            <div className="text-center mt-6 sm:mt-8">
              <p className="text-muted-foreground text-xs sm:text-sm">
                © 2025 Glowify. Illuminate your space with anime magic.
              </p>
            </div>
          </div>
        </div>
      ...
      <Authenticated>
        <Header 
          ...
          onCustomClick={() => setCurrentView("custom")}
        ...
        <main className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 md:py-8">
          ...
          {currentView === "custom" && (
            <CustomPhotoFrame onBack={handleBackToHome} />
          )}
        </main>
      </Authenticated>
